module.exports = {
  ...
  parserOptions: {
    // прочитать
    ecmaFeatures: {
      // включает jsx, но не ясно, для чего, вроде и без него работает. возможно реализован в коком-то extends
      jsx: true,
    },

    // определяет версию es синтаксиса, которую мы хотим использовать, но скорее всего у es2021 есть приоритет над этой опцией
    ecmaVersion: 'latest',
